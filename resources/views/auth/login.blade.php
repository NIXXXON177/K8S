    ...
    <div class="w-full max-w-md">
        <div class="bg-card rounded-xl border border-surface-border p-8">
            <div class="text-center mb-8">
                ...
                <h1 class="text-xl font-bold text-white">Вход в личный кабинет</h1>
                <p class="text-sm text-text-muted mt-1">Войдите для управления заявками</p>
            </div>
            ...
            <p class="mt-6 text-center text-sm text-text-secondary">
                Нет аккаунта?
                <a href="{{ route('register') }}" class="text-accent hover:text-accent-hover font-medium">Зарегистрироваться</a>
            </p>
        </div>
    </div>
</div>
