    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('admin.screens.update', $screen) }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="width_px" class="block text-sm font-medium text-gray-700 mb-1">Ширина (px) *</label>
                ...
                <div>
                    <label for="height_px" class="block text-sm font-medium text-gray-700 mb-1">Высота (px) *</label>
