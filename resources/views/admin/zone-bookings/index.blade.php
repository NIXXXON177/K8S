                        ...
                        <td class="px-6 py-4">
                            <form action="{{ route('admin.zone-bookings.update-status', $booking) }}" method="POST" class="space-y-2">
                                ...
                                <div class="flex items-center gap-2 justify-end">
                                    <select name="status" class="text-sm bg-input-bg text-text-primary border border-input-border rounded px-2 py-1 focus:ring-2 focus:ring-accent zone-status-select" data-booking-id="{{ $booking->id }}">
