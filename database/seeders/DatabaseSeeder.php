...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $screens = [
            ['name' => 'Москва, межэтажка', 'location' => 'Зал Москва, межэтажное пространство', 'width_px' => 8192, 'height_px' => 1056, 'has_night_version' => false],
            ['name' => 'Лифты (2944x320)', 'location' => 'Лифтовые зоны', 'width_px' => 2944, 'height_px' => 320, 'has_night_version' => false],
            ['name' => 'Лифты (256x512)', 'location' => 'Лифтовые зоны', 'width_px' => 256, 'height_px' => 512, 'has_night_version' => false],
            ['name' => 'Лифты (384x512)', 'location' => 'Лифтовые зоны', 'width_px' => 384, 'height_px' => 512, 'has_night_version' => false],
            ['name' => 'Лифты (512x512)', 'location' => 'Лифтовые зоны', 'width_px' => 512, 'height_px' => 512, 'has_night_version' => false],
            ['name' => 'Москва, колонны', 'location' => 'Зал Москва, колонны', 'width_px' => 768, 'height_px' => 896, 'has_night_version' => false],
            ['name' => 'Межэт. у эскалаторов (6-7 эт.)', 'location' => 'Эскалаторы между 6 и 7 этажами', 'width_px' => 1792, 'height_px' => 256, 'has_night_version' => false],
            ['name' => 'Межэт. у эскалаторов (5-6 эт.)', 'location' => 'Эскалаторы между 5 и 6 этажами', 'width_px' => 2048, 'height_px' => 192, 'has_night_version' => false],
            ['name' => 'Межэт. у эскалаторов (4-5 эт., парковка)', 'location' => 'Эскалаторы между 4 и 5 этажами, парковка', 'width_px' => 2048, 'height_px' => 384, 'has_night_version' => false],
            ['name' => 'Межэт. у эскалаторов (4-5 эт.)', 'location' => 'Эскалаторы между 4 и 5 этажами', 'width_px' => 1792, 'height_px' => 384, 'has_night_version' => false],
            ['name' => 'Межэт. у эскалаторов (3-4 эт.)', 'location' => 'Эскалаторы между 3 и 4 этажами', 'width_px' => 2048, 'height_px' => 320, 'has_night_version' => false],
            ['name' => 'Межэт. у эскалаторов (2-3 эт.)', 'location' => 'Эскалаторы между 2 и 3 этажами', 'width_px' => 2048, 'height_px' => 320, 'has_night_version' => false],
            ['name' => 'Межэт. у эскалаторов (1-2 эт.)', 'location' => 'Эскалаторы между 1 и 2 этажами', 'width_px' => 2048, 'height_px' => 384, 'has_night_version' => false],
            ['name' => 'Межэт. у эскалаторов (0-1 эт.)', 'location' => 'Эскалаторы между 0 и 1 этажами', 'width_px' => 2048, 'height_px' => 320, 'has_night_version' => false],
            ['name' => 'Берлин, межэтажка (1-2 эт.)', 'location' => 'Зал Берлин, 1-2 этажи', 'width_px' => 7168, 'height_px' => 384, 'has_night_version' => false],
            ['name' => 'Берлин, межэтажка (3 эт.)', 'location' => 'Зал Берлин, 3 этаж', 'width_px' => 8320, 'height_px' => 320, 'has_night_version' => false],
            ['name' => 'Париж, межэтажка', 'location' => 'Зал Париж, межэтажное пространство', 'width_px' => 3840, 'height_px' => 352, 'has_night_version' => false],
            ['name' => 'Париж, напольные (наружные)', 'location' => 'Зал Париж, наружные напольные экраны', 'width_px' => 3840, 'height_px' => 704, 'has_night_version' => false],
            ['name' => 'Париж, напольные (внутренние)', 'location' => 'Зал Париж, внутренние напольные экраны', 'width_px' => 3840, 'height_px' => 800, 'has_night_version' => false],
            ['name' => 'Вход №3, тамбур', 'location' => 'Вход №3, тамбурная зона', 'width_px' => 2176, 'height_px' => 1108, 'has_night_version' => false],
            ['name' => 'Full HD (колонна)', 'location' => 'Колонна, Full HD экран', 'width_px' => 1920, 'height_px' => 1080, 'has_night_version' => false],
            ['name' => 'Фасады Дорогомиловская (4 шт.)', 'location' => 'Фасад, ул. Дорогомиловская, 4 экрана', 'width_px' => 1152, 'height_px' => 792, 'has_night_version' => true],
            ['name' => 'Фасад Дорогомиловская (центральный)', 'location' => 'Фасад, ул. Дорогомиловская, центральный', 'width_px' => 1216, 'height_px' => 896, 'has_night_version' => true],
            ['name' => 'Фасады площадь Евразии (3 шт.)', 'location' => 'Фасад, площадь Евразии, 3 экрана', 'width_px' => 576, 'height_px' => 544, 'has_night_version' => true],
            ['name' => 'Вход №1, левый', 'location' => 'Вход №1, левый экран', 'width_px' => 520, 'height_px' => 200, 'has_night_version' => true],
            ['name' => 'Вход №1, правый', 'location' => 'Вход №1, правый экран', 'width_px' => 560, 'height_px' => 200, 'has_night_version' => true],
            ['name' => 'Вход №2', 'location' => 'Вход №2', 'width_px' => 840, 'height_px' => 200, 'has_night_version' => true],
            ['name' => 'Вход №3', 'location' => 'Вход №3', 'width_px' => 1160, 'height_px' => 240, 'has_night_version' => false],
            ['name' => 'Вход №4', 'location' => 'Вход №4', 'width_px' => 1240, 'height_px' => 240, 'has_night_version' => false],
            ['name' => 'Вход №5', 'location' => 'Вход №5', 'width_px' => 1040, 'height_px' => 280, 'has_night_version' => false],
            ['name' => 'Витрина у входа №1', 'location' => 'Витрина рядом с входом №1', 'width_px' => 360, 'height_px' => 216, 'has_night_version' => true],
            ['name' => 'Витрина у входа №2', 'location' => 'Витрина рядом с входом №2', 'width_px' => 350, 'height_px' => 144, 'has_night_version' => true],
            ['name' => 'Берлин, напольный (2 эт.)', 'location' => 'Зал Берлин, напольный экран, 2 этаж', 'width_px' => 2048, 'height_px' => 1408, 'has_night_version' => false],
            ['name' => 'Экран над выходом №3', 'location' => 'Над выходом №3', 'width_px' => 4480, 'height_px' => 640, 'has_night_version' => false],
        ];
